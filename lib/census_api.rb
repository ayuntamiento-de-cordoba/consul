...
class CensusApi
  ...
  class Response
    ...
    def district_code
      ...
      district_03 = ["ARCANGEL", "FUENSANTA - SANTUARIO", "CAÑERO", "PARQUE FIDIANA", "EL ARENAL"]
      district_04 = ["VIÑUELA - RESCATADO", "LEVANTE", "FATIMA", "SAGUNTO", "FUENSANTILLA"]
      district_05 = ["ZUMBACON", "VALDEOLLEROS", "SANTA ROSA", "CAMPING", "BARRIO DEL NARANJO", "EL NARANJO", "BRILLANTE", "EL BRILLANTE", "EL TABLERO", "EL PATRIARCA", "ASOMADILLA", "HUERTA DE SAN RAFAEL"]
      district_06 = ["HUERTA DE LA REINA", "MORERAS", "MARGARITAS / COLONIA DE LA PAZ", "PARQUE FIGUEROA", "ARRUZAFILLA", "SANTA ISABEL", "HUERTA DE SANTA ISABEL", "ARROYO DEL MORO"]
      district_07 = ["SAN RAFAEL DE LA ALBAIDA", "ELECTROMECANICAS", "PALMERAS", "MIRALBAIDA", "AZAHARA"]
      district_08 = ["CERCADILLA", "CIUDAD JARDIN", "VISTA ALEGRE", "HUERTA DE LA MARQUESA", "PARQUE CRUZ CONDE - CORREGIDOR", "OLIVOS BORRACHOS - LAS DELICIAS", "POLÍGONO DE PONIENTE"]
      district_09 = ["ALAMEDA DEL OBISPO", "ARENALES (LOS)", "CASTILLO DE LA ALBAIDA", "ZONA PERIURBANA DE CORDOBA", "ENCINAREJO DE CORDOBA", "ERMITAS (LAS)", "HIGUERON (EL)", "MAJANEQUE", "MEDINA AZAHARA", "VILLARRUBIA", "SANTA MARIA DE TRASSIERRA", "VALCHILLON", "MORALES (LOS)"]
      district_10 = ["NUESTRA SEÑORA DE LINARES", "PEDROCHES", "PRAGDENA", "PUENTE VIEJO", "QUEMADAS (LAS)", "SANTO DOMINGO", "TORRES CABRERA", "SANTA CRUZ", "ALCOLEA", "CANSINOS (LOS)", "CERRO MURIANO"]
      ...
      if district_01.include?(neighborhood)
        ...
        return '09'
      elsif district_10.include?(neighborhood)
        return '10'
      end
    end
